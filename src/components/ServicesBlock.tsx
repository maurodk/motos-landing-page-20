                  ...
                  <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                      ...
                      <div className="space-y-4">
                        <h4 className="text-xl font-semibold text-gray-900 mb-4">O que está incluso:</h4>
                      ...
                      <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 sticky top-8">
                        <CardContent className="p-6">
                          <div className="text-center mb-6">
                            ...
                            <p className="text-gray-600">Preço pode variar conforme modelo</p>
                          </div>
                          ...
                          <div className="space-y-4 mb-8">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <span className="font-semibold text-gray-900">{service.warranty}</span>
                            </div>
                          </div>
