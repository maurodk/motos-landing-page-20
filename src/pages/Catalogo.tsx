...
const motos = [
  ...
  },
  {
    ...
    potencia: "32 HP",
    imagem:
      "https://images.unsplash.com/photo-1558663836-ec5b2cf50c9e?w=400&h=300&fit=crop",
  },
  {
    id: 6,
    nome: "City Commuter",
    ...
    potencia: "18 HP",
    imagem:
      "https://images.unsplash.com/photo-1568772585531-50dca7643651?w=400&h=300&fit=crop",
  },
];
...
const Catalogo = () => {
  ...
  const filteredMotos = motos.filter((moto) => {
    const matchesCategory =
      selectedCategory === "Todas" || moto.categoria === selectedCategory;
    const matchesSearch =
  ...
  const categories = [
    "Todas",
    ...Array.from(new Set(motos.map((moto) => moto.categoria))),
  ];
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-br from-white via-blue-50 to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto mb-8 animate-fade-in-up">
            Cada moto é uma obra de arte em movimento. Encontre sua próxima
            paixão.
          </p>
