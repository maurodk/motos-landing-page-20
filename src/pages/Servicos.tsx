...
const Servicos = () => {
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link to="/servicos" className="text-orange-400 font-semibold relative group">
                Serviços
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-12">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="text-orange-400 font-semibold"> qualidade garantida e técnicos especializados.</span>
            </p>
          </div>
      ...
      {/* Footer */}
      <footer className="relative bg-gray-900 border-t border-orange-500/30 mt-20">
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/catalogo?categoria=urbana" className="text-gray-300 hover:text-orange-400 transition-colors duration-300 text-base">Motos Urbanas</Link></li>
                <li><Link to="/catalogo?categoria=adventure" className="text-gray-300 hover:text-orange-400 transition-colors duration-300 text-base">Adventure</Link></li>
                <li><Link to="/catalogo?categoria=esportiva" className="text-gray-300 hover:text-orange-400 transition-colors duration-300 text-base">Esportivas</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/#sobre" className="text-gray-300 hover:text-orange-400 transition-colors duration-300 text-base">Sobre Nós</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/#contato" className="text-gray-300 hover:text-orange-400 transition-colors duration-300 text-base">Contato</Link></li>
