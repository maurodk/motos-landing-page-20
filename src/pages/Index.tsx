...
import Logo from "@/assets/logoteste.png"; // Importando a logo, se necessário
import MotoCross from "@/assets/mototeste.jpg"; // Importando a imagem de motocross, se necessário
...
const motosPopulares = [
  ...
  },
  {
    ...
    potencia: "95 HP",
    imagem:
      "https://images.unsplash.com/photo-1558264673-3dad0b3d5b85?w=400&h=300&fit=crop",
...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100 relative overflow-x-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="mb-8 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto leading-relaxed drop-shadow-lg backdrop-blur-sm">
              Descubra a adrenalina pura com nossa coleção exclusiva de
              motocicletas.
              <span className="text-cyan-300 font-semibold">
                {" "}
                Cada curva é uma nova aventura.
              </span>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center group cursor-pointer bg-white/15 backdrop-blur-lg rounded-3xl p-8 border-2 border-white/30 hover:bg-white/20 hover:border-white/50 transition-all duration-500 hover:scale-105 shadow-2xl">
              <div className="flex items-center justify-center mb-4">
                ...
                <span className="text-4xl font-black text-white group-hover:text-yellow-300 transition-colors duration-300">
                  4.9
                </span>
              </div>
              <p className="text-gray-200 group-hover:text-white transition-colors duration-300 font-semibold">
                Avaliação dos Clientes
              </p>
            </div>
            <div className="text-center group cursor-pointer bg-white/15 backdrop-blur-lg rounded-3xl p-8 border-2 border-white/30 hover:bg-white/20 hover:border-white/50 transition-all duration-500 hover:scale-105 shadow-2xl">
              <div className="text-4xl font-black text-white group-hover:text-cyan-300 transition-colors duration-300 mb-4">
                500+
              </div>
              <p className="text-gray-200 group-hover:text-white transition-colors duration-300 font-semibold">
                Motos Vendidas
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {motosPopulares.map((moto, index) => (
              <Card
                key={moto.id}
                className="group bg-white/80 dark:bg-gray-800/80 border-2 border-gray-200/50 dark:border-gray-700 hover:border-blue-300/70 dark:hover:border-blue-600 overflow-hidden hover:shadow-2xl hover:shadow-blue-600/20 transition-all duration-700 hover:transform hover:scale-105 backdrop-blur-sm rounded-2xl"
              >
                <div className="relative aspect-[4/3] overflow-hidden rounded-t-2xl">
                  ...
                  <div className="absolute top-4 right-4 flex gap-3 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0">
                    <Button
                      size="sm"
                      variant="ghost"
                      className="bg-white/90 backdrop-blur-md text-red-600 hover:bg-red-600 hover:text-white rounded-full w-12 h-12 p-0 border-2 border-white/50 shadow-lg hover:scale-110 transition-all duration-300"
                    >
                    ...
                    <Button
                      size="sm"
                      variant="ghost"
                      className="bg-white/90 backdrop-blur-md text-blue-600 hover:bg-blue-600 hover:text-white rounded-full w-12 h-12 p-0 border-2 border-white/50 shadow-lg hover:scale-110 transition-all duration-300"
                      asChild
                    >
                ...
                <CardContent className="p-8 bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-900">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-blue-600 dark:text-blue-400 text-sm italic font-medium bg-blue-50 dark:bg-blue-900/20 px-3 py-1 rounded-full">
                      {moto.descricao}
                    </p>
                  </div>
      ...
      <section
        id="sobre"
        className="relative py-24 bg-gradient-to-br from-white via-blue-50/30 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-hidden"
      >
        {/* Background Decoration */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                Desde 2009, a MotoSpeed tem sido pioneira em trazer as melhores
                motocicletas para o mercado brasileiro. Nossa paixão por duas
                rodas nos move a buscar constantemente a excelência.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-center bg-white/60 dark:bg-gray-800/60 p-4 rounded-2xl backdrop-blur-sm border border-blue-200/50 dark:border-gray-600 hover:bg-white/80 dark:hover:bg-gray-700/80 transition-all duration-300 group">
                  ...
                  <span className="text-gray-700 dark:text-gray-300 font-medium">
                    Atendimento 24/7 em todo território nacional
                  </span>
                </div>
                <div className="flex items-center bg-white/60 dark:bg-gray-800/60 p-4 rounded-2xl backdrop-blur-sm border border-blue-200/50 dark:border-gray-600 hover:bg-white/80 dark:hover:bg-gray-700/80 transition-all duration-300 group">
                  ...
                  <span className="text-gray-700 dark:text-gray-300 font-medium">
                    Certificação ISO 9001 em qualidade
                  </span>
                </div>
                <div className="flex items-center bg-white/60 dark:bg-gray-800/60 p-4 rounded-2xl backdrop-blur-sm border border-blue-200/50 dark:border-gray-600 hover:bg-white/80 dark:hover:bg-gray-700/80 transition-all duration-300 group">
                  ...
                  <span className="text-gray-700 dark:text-gray-300 font-medium">
                    Mais de 50.000 motociclistas satisfeitos
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto font-medium">
              O mercado de motocicletas no Brasil continua em crescimento
              acelerado
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 border-2 border-red-200/50 dark:border-red-800/50 group-hover:border-red-300/70 dark:group-hover:border-red-600/70 group-hover:shadow-2xl group-hover:shadow-red-500/20 transition-all duration-500 hover:scale-105">
                ...
                <div className="text-3xl font-black bg-gradient-to-r from-red-600 to-red-700 bg-clip-text text-transparent mb-3">
                  +23%
                </div>
            ...
            <div className="text-center group">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 border-2 border-blue-200/50 dark:border-blue-800/50 group-hover:border-blue-300/70 dark:group-hover:border-blue-600/70 group-hover:shadow-2xl group-hover:shadow-blue-500/20 transition-all duration-500 hover:scale-105">
                ...
                <div className="text-3xl font-black bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent mb-3">
                  2.1M
                </div>
                <p className="text-gray-600 dark:text-gray-400 font-medium">
                  Vendas no país
            ...
            <div className="text-center group">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 border-2 border-green-200/50 dark:border-green-800/50 group-hover:border-green-300/70 dark:group-hover:border-green-600/70 group-hover:shadow-2xl group-hover:shadow-green-500/20 transition-all duration-500 hover:scale-105">
                ...
                <div className="text-3xl font-black bg-gradient-to-r from-green-600 to-green-700 bg-clip-text text-transparent mb-3">
                  #1
                </div>
                <p className="text-gray-600 dark:text-gray-400 font-medium">
                  Em satisfação
            ...
            <div className="text-center group">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 border-2 border-purple-200/50 dark:border-purple-800/50 group-hover:border-purple-300/70 dark:group-hover:border-purple-600/70 group-hover:shadow-2xl group-hover:shadow-purple-500/20 transition-all duration-500 hover:scale-105">
                ...
                <div className="text-3xl font-black bg-gradient-to-r from-purple-600 to-purple-700 bg-clip-text text-transparent mb-3">
                  50K+
                </div>
                <p className="text-gray-600 dark:text-gray-400 font-medium">
                  Clientes ativos
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto font-medium leading-relaxed">
              Nossas motocicletas incorporam as mais avançadas tecnologias do
              mercado mundial, proporcionando uma experiência de pilotagem
              incomparável.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-2 border-red-200/50 dark:border-red-800/50 rounded-3xl p-8 hover:border-red-300/70 dark:hover:border-red-600/70 hover:shadow-2xl hover:shadow-red-500/20 transition-all duration-500 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold bg-gradient-to-r from-red-600 to-red-700 bg-clip-text text-transparent mb-4">
                Injeção Eletrônica
              </h3>
              <p className="text-gray-600 dark:text-gray-400 font-medium">
                Sistema avançado para máximo desempenho e economia
              </p>
            </div>
            ...
            <div className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-2 border-blue-200/50 dark:border-blue-800/50 rounded-3xl p-8 hover:border-blue-300/70 dark:hover:border-blue-600/70 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 hover:transform hover:scale-105">
              ...
              <p className="text-gray-600 dark:text-gray-400 font-medium">
                Segurança máxima em todas as condições
              </p>
            </div>
            ...
            <div className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-2 border-green-200/50 dark:border-green-800/50 rounded-3xl p-8 hover:border-green-300/70 dark:hover:border-green-600/70 group-hover:shadow-2xl group-hover:shadow-green-500/20 transition-all duration-500 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold bg-gradient-to-r from-green-600 to-green-700 bg-clip-text text-transparent mb-4">
                GPS Integrado
              </h3>
              <p className="text-gray-600 dark:text-gray-400 font-medium">
                Navegação inteligente e conectividade total
              </p>
            </div>
            ...
            <div className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-2 border-purple-200/50 dark:border-purple-800/50 rounded-3xl p-8 hover:border-purple-300/70 dark:hover:border-purple-600/70 group-hover:shadow-2xl group-hover:shadow-purple-500/20 transition-all duration-500 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-purple-700 bg-clip-text text-transparent mb-4">
                Controle de Tração
              </h3>
              <p className="text-gray-600 dark:text-gray-400 font-medium">
                Estabilidade e controle em qualquer terreno
              </p>
            </div>
          </div>
        </div>
      ...
      <footer
        id="contato"
        className="relative bg-gradient-to-br via-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 border-gradient-to-r from-white to-white overflow-hidden"
      >
        {/* Background Decoration */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="grid md:grid-cols-4 gap-12">
            <div className="space-y-6">
              <div className="flex items-center mb-8">
                ...
                <span className="text-2xl font-black text-blue-600 dark:text-blue-400 ml-4"></span>
              </div>
              <p className="text-gray-600 dark:text-gray-300 text-base leading-relaxed font-medium">
                Transformando sonhos em realidade sobre duas rodas há mais de 15
                anos.
              </p>
            ...
            <div>
              <h4 className="font-black bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-8 text-xl">
                Produtos
              </h4>
              <ul className="space-y-4">
                <li>
                  <Link
                    to="/catalogo"
                    className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300 text-base font-medium hover:bg-blue-50 dark:hover:bg-blue-900/20 p-2 rounded-lg block"
                  >
                    Catálogo Completo
                  </Link>
                </li>
                <li>
                  <a
                    href="/catalogo?categoria=urbana"
                    className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300 text-base font-medium hover:bg-blue-50 dark:hover:bg-blue-900/20 p-2 rounded-lg block"
                  >
                    Motos Urbanas
                  </a>
                ...
                <li>
                  <a
                    href="/catalogo?categoria=adventure"
                    className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300 text-base font-medium hover:bg-blue-50 dark:hover:bg-blue-900/20 p-2 rounded-lg block"
                  >
                    Adventure
                  </a>
                ...
                <li>
                  <a
                    href="/catalogo?categoria=esportiva"
                    className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300 text-base font-medium hover:bg-blue-50 dark:hover:bg-blue-900/20 p-2 rounded-lg block"
                  >
                    Esportivas
                  </a>
          ...
          <div className="border-t-2 border-gray-200/50 dark:border-gray-700/50 mt-16 pt-10">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
              <p className="text-gray-500 dark:text-gray-400 text-base font-medium">
                &copy; 2025 Suzuki Urbanu's. Dominando as estradas com estilo.
              </p>
              <div className="flex flex-wrap gap-8">
                <a
                  href="#"
                  className="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300 text-base font-medium hover:bg-blue-50 dark:hover:bg-blue-900/20 px-3 py-1 rounded-lg"
                >
